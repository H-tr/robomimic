...
class BaseConfig(Config):
    ...
    def experiment_config(self):
        ...
        self.experiment.mse.every_n_epochs = (
            50  # log model prediction MSE every n epochs
        )
        self.experiment.mse.on_save_ckpt = (
            True  # log model prediction MSE on model checkpoint
        )
        self.experiment.mse.num_samples = (
            20  # number of datapoints to use for MSE prediction
        )
        ...
        self.experiment.rollout.batched = (
            False  # whether to parallelize evaluations over batched environments
        )
    ...
    def observation_config(self):
        ...
        self.observation.encoder.scan.core_class = (
            "ScanCore"  # Default ScanCore class uses Conv1D to process this modality
        )
